...
const { verifyYourAccount, sendEmail, forgotPasswordEmail } = require("../utils/mailer");
...
const forgetAccount = async (email) => {
  ...
  if (!user && !similarCompany) throw createError(400, `Aucun compte avec cet e-mail`);
