...
const { validateCurrentUserUpdate } = require("../middleware/verifyTalent.midddleware");

const { uploadImage } = require("../utils/multer");
const { uploadPDF } = require("../utils/multerCV");

router.put("/updateUserData",validateCurrentUserUpdate, userController.updateUser);
